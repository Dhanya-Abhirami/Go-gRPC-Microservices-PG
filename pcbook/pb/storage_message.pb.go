...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=dhanya.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0d, 0x64, 0x68, 0x61, 0x6e, 0x79, 0x61, 0x2e,
	0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x1a, 0x14, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x5f, 0x6d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x98, 0x01, 0x0a,
	0x07, 0x53, 0x74, 0x6f, 0x72, 0x61, 0x67, 0x65, 0x12, 0x35, 0x0a, 0x06, 0x64, 0x72, 0x69, 0x76,
	0x65, 0x72, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1d, 0x2e, 0x64, 0x68, 0x61, 0x6e, 0x79,
	...
	0x2d, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32,
	0x15, 0x2e, 0x64, 0x68, 0x61, 0x6e, 0x79, 0x61, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x0a, 0x03, 0x53, 0x53, 0x44, 0x10, 0x02, 0x42, 0x06, 0x5a, 0x04, 0x2e, 0x3b, 0x70, 0x62, 0x62,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: dhanya.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: dhanya.pcbook.Storage
	(*Memory)(nil),      // 2: dhanya.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: dhanya.pcbook.Storage.driver:type_name -> dhanya.pcbook.Storage.Driver
	2, // 1: dhanya.pcbook.Storage.memory:type_name -> dhanya.pcbook.Memory
